...
function displaySearchForm(){
  ...
  Search in this box for a movie
  <form action="./search.php" method="post">
    <input type="text" required name="keyword" id="keyword">
    <a href="index.php"><button type="button" formnovalidate class="button">Cancel</button></a>
...
function displaySearchResults($searchString){
  ...
  echo '</table>';
  echo '<a href="index.php"><button type="button" formnovalidate class="button">Cancel</button></a>';
}
